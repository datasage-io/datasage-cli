...
func (c *policyClient) ReadPolicy(ctx context.Context, in *ReadPolicyYAMLFile, opts ...grpc.CallOption) (*PolicyResponse, error) {
	out := new(PolicyResponse)
	err := c.cc.Invoke(ctx, "/policy.Policy/ReadPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PolicyServer interface {
	ReadPolicy(context.Context, *ReadPolicyYAMLFile) (*PolicyResponse, error)
...
func _Policy_ReadPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadPolicyYAMLFile)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyServer).ReadPolicy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/policy.Policy/ReadPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServer).ReadPolicy(ctx, req.(*ReadPolicyYAMLFile))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Policy_ReadPolicy_Handler,
		},
	},
